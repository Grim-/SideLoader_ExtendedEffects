...
public class SL_SummonExtension : SL_Effect, ICustomModel
{
    ...
    {
        SLEx_SummonExtension SLEx_SummonExtension = component as SLEx_SummonExtension;

        SLEx_SummonExtension.NewBaseColor = NewBaseColor;
        SLEx_SummonExtension.NewParticlesColor = NewParticlesColor;
        SLEx_SummonExtension.NewWeaponDamage = new DamageType(NewWeaponDamage.Type, NewWeaponDamage.Damage);
        SLEx_SummonExtension.StatusEffectOnSpawn = StatusEffectOnSpawn;
    }
